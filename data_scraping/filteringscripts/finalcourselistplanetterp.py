...
filename = r'/home/atajne/terpilot/data_scraping/intermediatedata/unique_courses_planetterp.json'
data = read_from_json(filename)

grading_courses = data['grading_courses']
info_courses = data['info_courses']

intersection, removed_from_grading, removed_from_info = get_intersection_and_difference(grading_courses, info_courses)

print("Intersection: ", intersection)
print("Removed from grading_courses: ", removed_from_grading)
print("Removed from info_courses: ", removed_from_info)
